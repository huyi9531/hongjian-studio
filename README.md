...
Image generation currently supports Volcengine Ark only. The Settings page offers Seedream 4.5 (`2K`, `4K`) and Seedream 5.0 Pro (`1K`, `2K`); unsupported resolutions are hidden.
