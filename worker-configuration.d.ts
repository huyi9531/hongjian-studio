/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e27549f7b4bee82b9d6792963ff646a8)
// Runtime types generated with workerd@1.20260811.1 2026-08-17 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	PLATFORM: "cloudflare";
	AICONDUCTOR_API_KEY: string;
	APP_ACCESS_PASSWORD: string;
	SESSION_SECRET: string;
	DATABASE_URL: string;
	DATA_DIR: string;
	XHS_PUBLISH_API_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PLATFORM" | "AICONDUCTOR_API_KEY" | "APP_ACCESS_PASSWORD" | "SESSION_SECRET" | "DATABASE_URL" | "DATA_DIR" | "XHS_PUBLISH_API_URL" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_ENDPOINT" | "R2_BUCKET_NAME" | "R2_REGION" | "R2_PUBLIC_URL">> {}
}
