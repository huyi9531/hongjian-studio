...
function SettingsPage() {
  ...
  return <AppShell><section className="mx-auto max-w-5xl px-4 py-8 sm:px-8 sm:py-10 lg:px-10">
    <WorkspacePageHeader eyebrow="红笺 · 配置" title="设置" description="按用途管理模型渠道和默认生成参数。" actions={<Button onClick={save} disabled={pending}>{pending ? <LoaderCircle className="animate-spin" /> : <Save />}保存设置</Button>} />
