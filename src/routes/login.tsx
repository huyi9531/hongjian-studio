  ...
  return <main className="min-h-[100dvh] bg-background pt-16">
    ...
    <section className="grid min-h-[calc(100dvh-64px)] place-items-center p-5 sm:p-10">
      <form onSubmit={submit} className="w-full max-w-md rounded-2xl bg-card p-6 sm:p-8">
        <div className="mb-8"><span className="grid size-11 place-items-center rounded-full bg-muted text-foreground"><KeyRound size={19} aria-hidden="true" /></span><h1 className="mt-6 text-2xl font-semibold">进入工作台</h1><p className="mt-2 text-sm text-muted-foreground">输入访问密码继续创作。</p></div>
